...
export function startCredentialProxy(
  ...
  // ANTHROPIC_AUTH_TOKEN (e.g. OpenRouter key) also triggers api-key mode:
  // it gets injected as x-api-key so no OAuth exchange endpoint is needed.
  ...
  // Strip trailing slash so we can cleanly prefix req.url (which starts with /)
